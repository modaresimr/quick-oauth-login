=== Quick OAuth Login
 ===
Contributors: modaresimr, andreiigna
...
Enable secure login & registration with social accounts! Supports Oauth, Twitter, Facebook, Google, WordPress.com, LinkedIn and Slack.

== Description ==

**Quick OAuth Login
** lets site visitors login or register **with a single click**! Adds login with Facebook, Google, Twitter, LinkedIn, Slack and WordPress.com on Login page, Register page, Comment forms and WooCommerce Checkout.
...
> Be aware that Quick OAuth Login

 requires the PHP version to be at least 5.6

== Frequently Asked Questions ==

= How to enable login providers? =

All login providers are available on “WP Admin -> Settings -> Quick OAuth Login
...
Quick OAuth Login
 ...
 can add buttons on Login, Register, Comment and WooCommerce pages through plugin options.
Login buttons can be added in pages, articles or widgets with `[quick-login]` shortcode. There are more details on how to embed this shortcode in “WP Admin -> Settings -> Quick OAuth Login

 -> Embed section” on your site.

= How the login or register process works? =

When a site visitor clicks on a Quick OAuth Login

 button, ex: `Login with Google`, the following process takes place:
...
= Quick OAuth Login
 ...
 doesn't work, with errors on pages or logins not showing up =
...
1. Login form with Quick OAuth Login

 buttons
2. WooCommerce Checkout with Quick OAuth Login
...
* Updated - Plugin name is changed from "Quick Login" to "Quick OAuth Login

" to better reflect what feature it adds to a website
